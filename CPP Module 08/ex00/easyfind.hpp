...
typename T::iterator easyfind(T& container, const U& value) {     // we have a function called easyfind that returns an iterator (a pointer to an element in the container) to a T type container

...
int main() {
    try {
        ...
        std::cout << "1- Creating a valid form and bureaucrats..." << std::endl;
        ...
        std::cout << "\n2- Trying to sign form with Bob (grade 50)..." << std::endl;
        bob.signForm(taxForm);

        // Test signing form - should succeed
        std::cout << "\n3- Trying to sign form with Alice (grade 20)..." << std::endl;
        alice.signForm(taxForm);

        // Form should be signed now
        std::cout << "\n4- Form status after Alice's signature attempt:" << std::endl;
        std::cout << taxForm << std::endl;

        // Trying to sign an already signed form
        std::cout << "\n5- Trying to sign an already signed form with Bob..." << std::endl;
        bob.signForm(taxForm);
    }
    ...
    try {
        ...
        std::cout << "\n6- Trying to create a form with sign grade 0..." << std::endl;
    ...
    try {
        ...
        std::cout << "\n7- Trying to create a form with execute grade 151..." << std::endl;
